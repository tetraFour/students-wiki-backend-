...
class AuthController implements IControllerBase {
  ...
  public initRoutes = (): void => {
    this.router.post(`${this.path}/signin`, signInValidation, this.signIn);
    this.router.post(`${this.path}/signup`, signUpValidation, this.signUp);
    this.router.get(`${this.path}/protected`,
        passport.authenticate("jwt", { session: false }), this.protected);
  ...
  private test = (req: Request, res: Response) => {
    ...
    return res.status(200).send("good job, server is working")
  }
}
